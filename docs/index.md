...
Enabled by default to stabilize RL training:
...
- [Installation Guide](installation.md) - Set up AC Bridge
- [Quick Start](getting-started.md) - Build your first integration
- [API Overview](api/overview.md) - Explore the core API
...
!!! info
    UDP telemetry was explored but abandoned in favor of shared memory due to reliability issues and higher latency.
